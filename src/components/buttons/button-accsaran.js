...
module.exports = {
    ...
    run: async (client, interaction) => {
          try {
            ...
            if (!embed) {
                return interaction.reply({ content: 'No suggestion found in this message.', ephemeral: true });
            }
            ...
            await interaction.reply({ content: `Suggestion has been marked as Accept.`, ephemeral: true });
          } catch (error) {
            console.error(error);
